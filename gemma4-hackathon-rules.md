...
## 0. COMPETITION-SPECIFIC TERMS

### 1. COMPETITION TITLE

Build with Gemma: ML, AI, Deep Learning & NLP Community Hackathon
...
https://www.kaggle.com/competitions/build-with-gemma-ml-ai-deep-learning-nlp-community/

### 5. TOTAL PRIZES AVAILABLE: To Be Announced (TBA)
...
Competition Data will not be provided for this Hackathon. Participants are expected to build their own applications using Gemma. Publicly available datasets may be used where appropriate, provided they comply with their respective licenses.
...
Build an AI application powered by Gemma 4 that solves a real-world problem.

Participants are encouraged to leverage Gemma 4's language understanding, reasoning, multimodal, and agentic capabilities to create innovative solutions across any domain.

Projects should demonstrate meaningful use of Gemma as the primary intelligence behind the solution and deliver a functional prototype by the end of the hackathon.
...
Projects that do not make meaningful use of Gemma as a core component of the solution may be disqualified from judging.

### 🏆 Prize Pool

🥇 First Place — USD $1,000

🥈 Second Place — USD $600

🥉 Third Place — USD $400

Prize money will be awarded after verification of eligibility and compliance with all competition rules.

### 1. TEAM LIMITS

a. The maximum Team size is three (3).. b. Team mergers are allowed and can be performed by the Team leader. In order to merge, the combined Team must have a total Submission count less than or equal to the maximum allowed as of the Team Merger Deadline. The maximum allowed is the number of Submissions per day multiplied by the number of days the competition has been running. For Hackathons, each team is allowed one (1) Submission; any Submissions submitted by Participants before merging into a Team will be unsubmitted.

### 2. SUBMISSION LIMITS

a. Each Team may submit one (1) final Submission for judging. b. Teams may update their Submission until the Final Submission Deadline. c. Only the latest Submission before the deadline will be considered for evaluation..
...
No official dataset will be provided for this Hackathon.

Teams are encouraged to identify and use publicly available datasets relevant to their project. Any datasets used must comply with their respective licenses and terms of use.

b. Data Security

Participants are responsible for ensuring they have the legal right to use any datasets included in their projects.

### 5. WINNER LICENSE

Winner license requirements are not applicable for this community hackathon.

### 6. EXTERNAL DATA AND TOOLS

Participants may use publicly available datasets, open-source libraries, frameworks, and developer tools.

Every submission must use Gemma 4 as its primary AI model.

Gemma 4 must be the only Large Language Model (LLM) used to power the application's AI capabilities.

Traditional machine learning libraries, computer vision models, OCR libraries, speech processing libraries, databases, vector stores, APIs, and other non-generative AI techniques may be used where appropriate, provided they support the application and do not replace Gemma 4 as the primary AI model.

The use of any other LLMs or generative foundation models is prohibited.

### 7. ELIGIBILITY

The competition is open only to currently enrolled university students in Bangladesh.

Teams may consist of one (1) to three (3) members.

Each participant may join only one team.

### 8. WINNER'S OBLIGATIONS

Winning teams must provide the following before receiving their prizes:
...
- Working Prototype or Live Demonstration

Winning teams may also be invited to present their projects during the final judging session.
